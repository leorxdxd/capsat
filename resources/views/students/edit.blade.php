<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('students.show', $student) }}" class="text-gray-500 hover:text-sisc-purple flex items-center text-sm font-bold transition-colors">
        ...
        <div class="w-full px-4 sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('students.update', $student) }}" class="space-y-6">
                            ...
                            <div>
                                ...
                                <select name="current_grade_level" required class="w-full border-gray-300 rounded-lg focus:ring-2 focus:ring-sisc-purple focus:border-sisc-purple transition-shadow">
                                    ...
                                    @foreach(['Kinder', 'Grade 1', 'Grade 2', 'Grade 3', 'Grade 4', 'Grade 5', 'Grade 6', 'Grade 7', 'Grade 8', 'Grade 9', 'Grade 10', 'Grade 11', 'Grade 12'] as $grade)
                                        <option value="{{ $grade }}" {{ old('current_grade_level', $student->current_grade_level) === $grade ? 'selected' : '' }}>{{ $grade }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                ...
                <div class="flex items-center justify-end gap-4 pt-4">
                    <a href="{{ route('students.show', $student) }}" class="px-6 py-3 text-gray-600 font-bold rounded-lg hover:bg-gray-100 transition-colors">
                        Cancel
                    </a>
