            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead class="bg-sisc-purple text-white">
                        <tr>
                            <th class="px-6 py-4 text-left text-xs font-bold uppercase tracking-wider text-sisc-gold">Filename</th>
                            <th class="px-6 py-4 text-left text-xs font-bold uppercase tracking-wider text-sisc-gold">Size</th>
