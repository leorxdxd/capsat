                ...
                <div class="p-8 text-gray-900">
                    <form method="POST" action="{{ route('norms.store') }}">
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input id="name" class="block mt-2 w-full border-gray-300 focus:border-sisc-purple focus:ring-sisc-purple rounded-none shadow-sm" type="text" name="name" :value="old('name')" required placeholder="e.g., OLSAT Grade 1 Norms" />
                        ...
                        <div class="mb-8">
                            ...
                            <textarea id="description" name="description" 
                                ...
                                rows="3" placeholder="Optional description for this norm table">{{ old('description') }}</textarea>
                            <x-input-error :messages="$errors->get('description')" class="mt-2" />
                        </div>

                        <div class="flex items-center justify-end gap-4 border-t border-gray-100 pt-6">
                            <a href="{{ route('norms.index') }}" class="text-gray-500 hover:text-gray-900 font-medium transition-colors">Cancel</a>
